...
class AssetManager:
    ...
    def load(self):
        ...
        # simple string
        self.catController.load(persistance.readEnumsIfExists(self.rootDir + categoryFilePath))
        self.itemtypeController.load(persistance.readEnumsIfExists(self.rootDir + itemtypeFilePath))
    ...
    def store(self):
        ...
        persistance.storeEnums(self.rootDir + itemtypeFilePath,self.itemtypeController.getList())
