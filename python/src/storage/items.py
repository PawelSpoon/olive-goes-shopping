...
def getUnits():
    ...
    retItems.append({ "Id":getId(retItems), "Name": "10er", "Phydim": "Piece", "Factor": 10, "Offset": 0})
...
def getFood():
    ...
    retItems.append({ "Id":getId(retItems), "Name": qsTr("apple cider vinegar"),"Amount":1000,"Unit":"ml", "ItemType" : "food"})
    retItems.append({ "Id":getId(retItems), "Name": qsTr("asian noodels")      ,"Amount":1000,"Unit":"g" , "ItemType" : "food"})
    ...
    retItems.append({ "Id":getId(retItems), "Name": qsTr("balsamic vinegar")    ,"Amount":1000,"Unit":"ml", "ItemType" : "food"})
    retItems.append({ "Id":getId(retItems), "Name": qsTr("banana")             ,"Amount":4   ,"Unit":"-" , "ItemType" : "food", "Category" : qsTr("fresh produce")})
    retItems.append({ "Id":getId(retItems), "Name": qsTr("basmati rice")       ,"Amount":1000,"Unit":"g" , "ItemType" : "food"})
    ...
    retItems.append({ "Id":getId(retItems), "Name": qsTr("bread")              ,"Amount":1000,"Unit":"g" , "ItemType" : "food"})
    retItems.append({ "Id":getId(retItems), "Name": qsTr("button mushrooms")   ,"Amount":250 ,"Unit":"g" , "ItemType" : "food", "Category" : qsTr("fresh produce")})
    retItems.append({ "Id":getId(retItems), "Name": qsTr("spelled flour")      ,"Amount":1000,"Unit":"g" , "ItemType" : "food"})
    retItems.append({ "Id":getId(retItems), "Name": qsTr("caned tomatoes")     ,"Amount":400 ,"Unit":"g" , "ItemType" : "food"})
    retItems.append({ "Id":getId(retItems), "Name": qsTr("eg")                 ,"Amount":10  ,"Unit":"-" , "ItemType" : "food"})
    ...
    retItems.append({ "Id":getId(retItems), "Name": qsTr("vegetable stock")    ,"Amount":1000,"Unit":"g" , "ItemType" : "food"})
    ...
    retItems.append({ "Id":getId(retItems), "Name": qsTr("oat milk")           ,"Amount":1000,"Unit":"ml", "ItemType" : "food"})
    retItems.append({ "Id":getId(retItems), "Name": qsTr("millet")             ,"Amount":1000,"Unit":"g" , "ItemType" : "food"})
    ...
    retItems.append({ "Id":getId(retItems), "Name": qsTr("carrots")            ,"Amount":1000,"Unit":"g" , "ItemType" : "food", "Category" : qsTr("fresh produce")})
    ...
    retItems.append({ "Id":getId(retItems), "Name": qsTr("chickpea flour")     ,"Amount":1000,"Unit":"g" , "ItemType" : "food"})
    ...
    retItems.append({ "Id":getId(retItems), "Name": qsTr("milk")               ,"Amount":1000,"Unit":"ml", "ItemType" : "food"})
    retItems.append({ "Id":getId(retItems), "Name": qsTr("italian rice")       ,"Amount":1000,"Unit":"g", "ItemType" : "food"})
    retItems.append({ "Id":getId(retItems), "Name": qsTr("cereal")             ,"Amount":500 ,"Unit":"g", "ItemType" : "food"})
    retItems.append({ "Id":getId(retItems), "Name": qsTr("noodels")            ,"Amount":1000,"Unit":"g", "ItemType" : "food"})
    ...
    retItems.append({ "Id":getId(retItems), "Name": qsTr("olive oil")          ,"Amount":1000,"Unit":"ml", "ItemType" : "food"})
    retItems.append({ "Id":getId(retItems), "Name": qsTr("oranges")            ,"Amount":1000,"Unit":"g" , "ItemType" : "food", "Category" : qsTr("fresh produce")})
    retItems.append({ "Id":getId(retItems), "Name": qsTr("bell pepper")        ,"Amount":1   ,"Unit":"-" , "ItemType" : "food", "Category" : qsTr("fresh produce")})
    retItems.append({ "Id":getId(retItems), "Name": qsTr("parboiled rice")     ,"Amount":1000,"Unit":"g" , "ItemType" : "food"})
    ...
    retItems.append({ "Id":getId(retItems), "Name": qsTr("quinoa")             ,"Amount":1000,"Unit":"g" , "ItemType" : "food"})
    retItems.append({ "Id":getId(retItems), "Name": qsTr("rapeseed oil")       ,"Amount":1000,"Unit":"ml", "ItemType" : "food"})
    retItems.append({ "Id":getId(retItems), "Name": qsTr("beef")               ,"Amount":1000,"Unit":"g" , "ItemType" : "food"})
    retItems.append({ "Id":getId(retItems), "Name": qsTr("rye flour")          ,"Amount":1000,"Unit":"g" , "ItemType" : "food"})
    ...
    retItems.append({ "Id":getId(retItems), "Name": qsTr("sticky rice")        ,"Amount":1000,"Unit":"g", "ItemType" : "food"})
    retItems.append({ "Id":getId(retItems), "Name": qsTr("pastry")             ,"Amount":1,"Unit":"-", "ItemType" : "food"})
    retItems.append({ "Id":getId(retItems), "Name": qsTr("soup noodles")       ,"Amount":1000,"Unit":"g", "ItemType" : "food"})
    ...
    retItems.append({ "Id":getId(retItems), "Name": qsTr("wheat flour")        ,"Amount":1000,"Unit":"g", "ItemType" : "food"})
    ...
    retItems.append({ "Id":getId(retItems), "Name": qsTr("sugar")              ,"Amount":1000,"Unit":"g", "ItemType" : "food"})
    retItems.append({ "Id":getId(retItems), "Name": qsTr("onion")              ,"Amount":1000,"Unit":"g", "ItemType": "food", "Category" : qsTr("fresh produce")})
